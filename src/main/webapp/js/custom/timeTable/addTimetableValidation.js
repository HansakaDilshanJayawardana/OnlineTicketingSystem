function addTimetableValidation() {
    var name = document.forms["createTimetable"]["name"].value;
    var startingTime = document.forms["createTimetable"]["startingTime"].value;
    var startingPoint = document.forms["createTimetable"]["startingPoint"].value;
    var endTime = document.forms["createTimetable"]["endTime"].value;
    var destination = document.forms["createTimetable"]["destination"].value;
