  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <h1 class="h3 mb-4 text-gray-800">Add Passenger Details</h1>
        ...
        <form class="user" id="addStudentForm">
          ...
          <div class="form-group">
            <label>NIC *Required for local passengers only</label>
            <input type="text" id="nic" name="nic" class="form-control form-control-user"  placeholder="National Identity Card Number">
          </div>


          <div class="form-group">
            <label>Passport Number *Required for foreign passengers only</label>
            <input type="text" id="passport" name="passport" class="form-control form-control-user"  placeholder="Passport Number ">
          </div>

          <input type="submit" id="submitBtn" onclick="validateSubmit(event)" class="btn btn-success btn-user btn-block" value="Save Passenger">
          <hr>
        </form>
...
<script type="text/javascript">
  ...
  document.getElementsByName("addmissionDate")[0].setAttribute('max',date);
  document.getElementsByName("dob")[0].setAttribute('max', date);
