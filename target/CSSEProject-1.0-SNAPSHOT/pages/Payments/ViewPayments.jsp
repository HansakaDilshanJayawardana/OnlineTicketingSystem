...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- End of Topbar -->
            <h1 class="h3 mb-4 text-gray-800">My Payments</h1>
                ...
                <div class="card bg-grey">
                    <div class="card-body text-center">
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <input type="text" placeholder="Search" id="txt" onkeyup="pay()"  style="width:100%">
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card-body" id="pdf">
                    <center>
                        ...
                        <h1 style="color: grey;">Payments Details</h1>
                    </center>
